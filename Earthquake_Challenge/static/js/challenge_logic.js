...
// Challenge: Create a third tile layer.
...
function loadmap() {
  L.control.layers(baseMaps, overlays2).addTo(map);
};
...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function (data) {
  ...
  let major_earthquakes = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson";
  ...
  d3.json(major_earthquakes).then(function (data) {
    console.log('testing');
    console.log(data);
